...
//postPage
exports.showPostPage = function(req,res,result){
    db.find("classify",{},function(err,result){
        if(err){
            ...
            res.render("postpage",obj);
        }
    });
    
};

exports.getPostPage = function(req,res,result){
    var page = req.body.page;
    var classify = req.body.classify;
    db.find("article",{"classify":classify},{"pageamount":10,"page":page,"sort":{"date":-1}},function(err,result){
        if(err){
            console.log(err);
        }
        else{
